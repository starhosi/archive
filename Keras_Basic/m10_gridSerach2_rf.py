...
parameters = [
    {'n_estimators': [3,5,7,10],'max_depth': [2,4,6,8,10],'min_samples_leaf' :[3,5,7,10]},
    {'n_estimators': [3,7,9,11],'max_depth': [3,5,7,9,11], 'min_samples_leaf' :[4,6,8,9]},
    {'n_estimators': [7,9,11,13],'max_depth': [5,7,9,11,13], 'min_samples_leaf' :[2,4,6,8]}   
